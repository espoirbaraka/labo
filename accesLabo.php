              ...
              <table id="tableau" class="table table-bordered" style="border-color: red;">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT CodeFrequantation, t_marque_ordinateur.Valeur as marque, t_couleur.Valeur as couleur, t_siege.EtiquetteSiege as siege, Date, Status, HeureArrive, HeureDepart, t_frequantant.Nom as nom, t_frequantant.Postnom as postnom, t_frequantant.Prenom as prenom, t_frequantant.Matricule as matricule FROM t_frequantation
                      INNER JOIN t_frequantant
                      ON t_frequantation.CodeFrequantant=t_frequantant.CodeFrequantant
                      INNER JOIN t_marque_ordinateur
                      ON t_frequantation.CodeMarque=t_marque_ordinateur.CodeMarque
                      INNER JOIN t_couleur
                      ON t_frequantation.CodeCouleur=t_couleur.CodeCouleur
                      INNER JOIN t_siege
                      ...
                      foreach($stmt as $frequantation){
                        ...
                        <tr>
                          ...
                          <td>".$frequantation['marque'].' / '.$frequantation['couleur']."</td>
