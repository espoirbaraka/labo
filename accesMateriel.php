                ...
                <tbody>
                  <?php
                    ...
                    try{
                      ...
                      WHERE t_frequantation.CodeService=?
                      ORDER BY Date DESC");
                      ...
                      foreach($stmt as $frequantation){
                        ...
                        <tr>
                          ...
                          <td>".$frequantation['marque'].' / '.$frequantation['etiquette']."
                          <span class='pull-right'><i class='fa fa-edit utilisateur' data-id='".$frequantation['CodeFrequantation']."'></i></span>
                          </td>
                      ...
                      ";
                        ...
                        else
                         {
                          ...
                          <tr>
                            ...
                            <td>".$frequantation['prenom']."</td>
                            <td>".$frequantation['matricule']."</td>
                            <td>".$frequantation['marque'].' / '.$frequantation['etiquette']."</td>
                            <td>".$frequantation['HeureArrive']."</td>
                            <td>".$frequantation['HeureDepart']."</td>
                            <td>
