  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Nos ordinateurs</li>
      </ol>
    </section>
                      ...
                      foreach($stmt as $ordinateur){
                        ...
                        echo "
                          <tr>
                            ...
                            <td>".$ordi."</td>
                            <td>".$ordinateur['Cle']."</td>
                            <td>".$ordinateur['Etiquette']."</td>
                            <td>".$ordinateur['User']."
                            <span class='pull-right'><i class='fa fa-edit utilisateur' data-id='".$ordinateur['CodeMateriel']."'></i></span>
                            </td>
