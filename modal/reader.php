...
$modele = $conn->prepare("SELECT * FROM t_modele_reader");
$modele->execute();
...
?>
<!-- Add -->
<div class="modal fade" id="addreader">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Ajouter reader</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="operation/add_reader.php" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select name="modele" id="modele" class="form-control">
                        ...
                        {
                            ?>
                            <option value="<?php echo $row['CodeMarqueReader']; ?>"><?php echo $row['Valeur']; ?></option>
                            <?php
