...
$marque = $conn->prepare("SELECT * FROM t_marque_routeur");
$marque->execute();
...
?>
<!-- Add -->
<div class="modal fade" id="addrouteur">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Ajouter routeur</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="operation/add_routeur.php" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select name="marque" id="marque" class="form-control">
                        ...
                        {
                            ?>
                            <option value="<?php echo $row['CodeMarqueRouteur']; ?>"><?php echo $row['Valeur']; ?></option>
                            <?php
