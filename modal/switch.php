...
$marque = $conn->prepare("SELECT * FROM t_marque_switch");
$marque->execute();
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="operation/add_switch.php" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select name="marque" id="marque" class="form-control">
                        ...
                        {
                            ?>
                            <option value="<?php echo $row['CodeMarqueSwitch']; ?>"><?php echo $row['Valeur']; ?></option>
                            <?php
